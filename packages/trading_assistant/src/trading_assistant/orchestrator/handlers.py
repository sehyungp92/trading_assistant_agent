...
from trading_assistant.orchestrator.orchestrator_brain import Action, OrchestratorBrain
...
class Handlers:
    ...
    def _monthly_model_review_invoker(self):
        ...
        from trading_assistant.skills.monthly_model_review_runner import MonthlyModelReviewInvocationResult
    ...
    async def handle_weekly_analysis(self, action: Action) -> None:
        ...
        try:
            ...
            try:
                from trading_assistant.skills.suggestion_scorer import SuggestionScorer as _Scorer
            ...
            try:
                if retro_builder is None:
                    from trading_assistant.skills.retrospective_builder import RetrospectiveBuilder as _RB
                    retro_builder = _RB(
                        runs_dir=self._runs_dir,
                        curated_dir=self._curated_dir,
                        memory_dir=self._memory_dir,
            ...
            try:
                ...
                if corrections:
                    ...
                    if pattern_report.patterns:
                        ...
                        try:
                            from trading_assistant.skills.learning_ledger import LearningLedger as _LL
                            correction_lessons = []
